...
On a ring topology we distribute the matrix in a different way. Each processors stores $\frac{N}{p^2}$ contiguous lines of the matrix. Thus, each processor only needs to get/send values to its 2 immediate neighbours in the ring.
